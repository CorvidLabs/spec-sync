...
## REQ-CHG-0034-001 — Explicit extensionless discovery
...
## REQ-CHG-0034-002 — Non-vacuous coverage
...
## REQ-CHG-0034-003 — Consistent source selection

Coverage, generation, scaffold, new-spec, wizard, diff, and output source scans SHALL use the same extensionless-selection rule so a file cannot be measurable in one command and invisible in another. Wizard discovery SHALL reject directory entries before matching module names or extensions.
