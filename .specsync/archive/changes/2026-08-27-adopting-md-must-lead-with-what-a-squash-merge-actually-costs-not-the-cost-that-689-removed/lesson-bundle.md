# Lesson bundle — adopting-md-must-lead-with-what-a-squash-merge-actually-costs-not-the-cost-that-689-removed
...
- **Title**: ADOPTING.md must lead with what a squash merge actually costs, not the cost that #689 removed
- **Kind**: Documentation
- **Paths**: docs/ADOPTING.md, CHANGELOG.md
- **Acceptance**: docs/ADOPTING.md states the independent review as the only cost a squash still carries, states separately that re-verification is not among them, contains no claim that a squash forces a re-verify, and reports the archive reachability figure in one direction with the current measurement (21 of 198).

## Evidence

- Verification commit: `4e867c639b9172c08b5b69f83a7f384dfb3742dc`
- Base commit: `a98fc3d167c8014eb1714026feab8f14c9cacf29`
