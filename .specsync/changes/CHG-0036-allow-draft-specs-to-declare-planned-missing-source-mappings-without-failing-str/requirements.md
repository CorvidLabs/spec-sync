...
## REQ-CHG-0036-001 — Planned draft mappings

SpecSync SHALL treat a safe missing path in a draft spec as a planned mapping by default.
...
## REQ-CHG-0036-002 — Strict opt-in and structural safety
