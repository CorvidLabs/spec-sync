...
- [x] Add unambiguous before/after flag examples to shared create-spec prompt templates.
- [x] Add generated-to-checked-in asset parity and idempotency regressions.
