...
The scope is documentation-only. It does not change canonical specs, source behavior, public APIs, or release metadata. It depends on accepted CHG-0048 so the documentation is verified against the stabilized 5.1.1 implementation and validation policy.
