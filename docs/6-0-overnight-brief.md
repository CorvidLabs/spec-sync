...
| Issues to close, with the citation to use | Fixed on main: #677 (`2d590b2f`, #681), #672 (`f94ff7e4`, #683), #603 (`408144b9`, #616), #667 (`77461a4a`, #668), #660 (`b3f3201a` #663, `7cbe820e` #665, `89886855` #666), #648 (`ad65908f`, #650), #631 (`875752ee`, #702), #641 (moot: `check` no longer walks SDD state, `[6.0.0]` changelog). Resolved outside main: #647 (all four consumers pin rc.12). Close at the stable tag, not before: #628 (`action.yml` default `6.0.0` is valid once `v6.0.0` exists). After #766 merges: #615. Verify each citation with `git log origin/main --grep` before closing. |
