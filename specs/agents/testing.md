...
| `src/agents.rs` (6.0 skill contract) | cargo test agents:: | `tracked_skill_files_carry_the_current_same_actor_guidance`, `tracked_skill_files_teach_check_is_the_product`; covers `REQ-agents-006` and `REQ-agents-007` |
