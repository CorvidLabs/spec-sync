...
| Retained omitted-source discovery | ignored-name symlink and FIFO manifest unit regressions | Ignored names are skipped before target inspection; recognized special-file manifests fail quickly with a configuration finding. |
