...
- [x] Close late release-validator bypasses by normalizing Action repository names case-insensitively and scanning YAML fences that include metadata while preserving exact ref checks
