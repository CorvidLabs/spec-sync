...
| Immutable RC qualification | Ubuntu and macOS run `fledge lanes run release-candidate` for the same resolved SHA | Parse the release matrix and validate fixture evidence for the two required platforms |
