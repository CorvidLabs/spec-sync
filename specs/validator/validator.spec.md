...
21. Checked spec and source traversal records child directory identities during deterministic
    ...
    capabilities. Live directory handles are bounded by depth rather than sibling count, and
    identity/reachability checks before and after recursion still reject replacement.
